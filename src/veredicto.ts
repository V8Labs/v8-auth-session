 ...
 */
export const VEREDICTOS_QUE_CIERRAN: ReadonlySet<string> = new Set([
 ...
 */
export const VEREDICTOS_QUE_AVISAN: ReadonlySet<string> = new Set([
...
export type FalloDeMe = { status?: number; error_code?: string } | null | undefined;
 ...
 */
export function esVeredictoDeExpulsion(e: unknown): boolean {
...
export function codigoDeFallo(e: unknown): string | null {
  const fallo = (e ?? {}) as NonNullable<FalloDeMe>;
